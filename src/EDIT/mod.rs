...
pub unsafe fn get_param_int_hook(x0: u64, x1: u64, x2 :u64) -> i32 {
    ...
    if smash::app::utility::get_category(boma_reference) == *BATTLE_OBJECT_CATEGORY_WEAPON && fighter_kind == *WEAPON_KIND_LINK_BOWARROW {
        if ARROW_TYPE[id] == 1 {
